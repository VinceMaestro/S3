 ...
 * Emits "done" event when streaming is complete and B2 has returned
 * results for putting each of the subparts
 * Emits "error" event if B2 returns an error for putting a subpart and
...
class ResultsCollector extends EventEmitter {
     ...
     * @param {(Error|undefined)} err - error returned from B2 after
     *  putting a subpart
 ...
 * @type {(Error|undefined)} err - error returned by B2 putting last subpart
 * @type {object[]} results - result for putting each of the subparts
 * @property {Error} [results[].error] - error returned by B2 putting subpart
 * @property {number} results[].subPartIndex - index of the subpart
 */
 /**
  * "error" event
  * @event ResultCollector#error
  * @type {(Error|undefined)} error - error returned by B2 last subpart
